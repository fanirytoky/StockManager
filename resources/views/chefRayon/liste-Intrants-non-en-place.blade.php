    ...
    <div class="white_shd full margin_bottom_30">
        <div class="full graph_head" id="entete">
            <div class="heading1 margin_0">
                <h2 style="color: white;">Liste des nouvelles Intrants de santé non mise en place</h2>
            </div>
        </div>
        <div class="table_section padding_infor_info">
            ...
            <div class="col-lg-12" id="ajaxliste-non-en-place">
            </div>
        </div>
    </div>
</div>
...
<script>
    function listeNewFiche(page) {
        ...
        xhr.onreadystatechange = (e) => {
            e.preventDefault()
            if (xhr.readyState === 4) {
                document.getElementById("ajaxliste-non-en-place").innerHTML = xhr.responseText
                console.log(xhr.responseText)
            }
        }
        var name = document.getElementById('searchBar').value
        if (page <= 1) var url = '/ChefRayon/AjaxListeFiche.new?filtre=' + name;
        else {
            var url = '/ChefRayon/AjaxListeFiche.new?filtre=' + name + '&&page=' + page;
        }
