<nav id="sidebar">
    ...
    <div class="sidebar_blog_2">
        ...
        <ul class="list-unstyled components">
            <li><a href="{{route('fiches')}}"><i class="fa fa-file-text-o green_color"></i> <span>Liste des fiches FCPCC</span></a></li>

            <!-- Administrateur -->
            @if(auth()->user() != null && auth()->user()->post_id == 1)
            <li>
                <a href="#admin" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-tasks blue2_color"></i> <span>Gestion Utilisateur</span></a>
                <ul class="collapse list-unstyled" id="admin">
                    <li><a href="{{route('user.Create')}}">> <span>Crée</span></a></li>
                    <li><a href="{{route('users')}}">> <span>Liste</span></a></li>
                </ul>
            </li>
            <li><a href="{{route('maj')}}"><i class="fa fa-database red_color"></i> <span>Mise à jour données</span></a></li>
            @endif
            <!-- Magasinier -->
            ...
            <li><a href="{{route('fiche.new')}}"><i class="fa fa-table blue2_color"></i> <span>Liste nouvelles fiches</span></a></li>
            @endif
            <!--  -->
            ...
            <li>
                ...
                <ul class="collapse list-unstyled" id="FCPCC">
                    ...
                    <li><a href="{{route('Pharma/fiche.attente')}}"><i class="fa fa-archive yellow_color"></i> <span>Liste mis en quarantaine</span></a></li>
            ...
            <li>
                <a href="#FCPCC" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-database blue2_color"></i> <span>Gestion FCPCC</span></a>
                <ul class="collapse list-unstyled" id="FCPCC">
                    <li><a href="{{route('Stock/fiche.new')}}"><span>Liste fiches validées</span></a></li>
                    <li><a href="{{route('Stock/fiche.attente')}}"><span>Liste fiches non validées</span></a></li>
                </ul>
            </li>
            @endif
            <!--  -->
            ...
            <li>
                ...
                <ul class="collapse list-unstyled" id="FCPCC">
                    <li><a href="{{route('ChefRayon/fiche.new')}}"><i class="fa fa-table purple_color"></i> <span>Lot non mise en place</span></a></li>
