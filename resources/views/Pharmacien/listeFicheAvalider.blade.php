    ...
    <div class="white_shd full margin_bottom_30">
        <div class="full graph_head" id="entete">
            <div class="heading1 margin_0">
                <h2 style="color: white;">Liste des nouvelles fiches à controler</h2>
            </div>
        </div>
...
<script>
    function listeNewFiche(page) {
        ...
        if (page <= 1) var url = '/Pharmacien/AjaxListeFiche.new?filtre=' + name;
        else {
            var url = '/Pharmacien/AjaxListeFiche.new?filtre=' + name + '&&page=' + page;
        }
